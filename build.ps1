# Script that builds libodbcmysql
#
# Version: 20180728
...
Else
{
	...
	If (-Not (Test-Path "${VSSolutionPath}"))
	{
		...
		Invoke-Expression -Command "& '${Python}' ${MSVSCppConvert} --output-format ${OutputFormat} ${MSVSCppConvertOptions} msvscpp\libodbcmysql.sln"
	}
}
$VSSolutionFile = "${VSSolutionPath}\libodbcmysql.sln"
